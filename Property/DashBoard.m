...
- (void)viewDidLoad
{
    ...
    menuScroll.frame=CGRectMake(0, 0, 53, 719);
...
- (IBAction)showMenu:(id)sender {
    ...
    if(!showMenuFlag)
    {
        ...
        if(((AppDelegate *)[UIApplication sharedApplication].delegate).selectedTab == 3)
        {
            [[NSNotificationCenter defaultCenter] postNotificationName:@"setEgyptViewAlignment" object:nil userInfo:nil];
        }
        
        menuScroll.frame=CGRectMake(0, 1400, 53, 719);
