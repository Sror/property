...
-(NSMutableArray*)LoadLocationList{
    ...
    //    SELECT CategoryPK, CategoryNameAra, CategoryNameEng FROM Category
    //   SELECT SaleTypePK, SaleTypeNameAra, SaleTypeNameEng FROM SaleType
...
-(NSMutableArray*)LoadPropertyList:(int)locationId :(int)propertyTypeId :(int)SalesTypeId :(int)categryId{
    ...
    //ORDER BY SaleTypeNameLangApprev  PropertyTypePK, SaleTypePK,  CategoryPK, CategoryNameLangApprev,  LocationPK,
