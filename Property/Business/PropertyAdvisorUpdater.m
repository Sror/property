...
-(void)GetServerUpdate
{
   ...
   // progressAlert   = [[UIAlertView alloc] initWithTitle:@"Downloading"  message: @"Please wait..." delegate: self cancelButtonTitle: nil otherButtonTitles: nil];
    ...
    theProgressView = [[UIProgressView alloc] initWithFrame:CGRectMake(0.0f, 500.0f, 1024.0f, 9.0f)];
    
    [theProgressView setProgressViewStyle: UIProgressViewStyleBar];
    
     [self.viewController.view addSubview:theProgressView];
    
    UILabel *downloading = [[UILabel alloc] initWithFrame:CGRectMake(430, 400, 300, 100)];
    [downloading setTextColor:[UIColor whiteColor]];
    [downloading setFont:[UIFont systemFontOfSize:12]];
    [downloading setText:@"Downloading, Please wait..."];
...
-(void)ShowUpdatingSplash{
   ...
   /* UILabel *downloading = [[UILabel alloc] initWithFrame:CGRectMake(430, 400, 300, 100)];
    [downloading setTextColor:[UIColor whiteColor]];
    [downloading setFont:[UIFont systemFontOfSize:12]];
    [downloading setText:@"Checking for new updates, Please wait..."];
    [self.viewController.view addSubview:downloading];
    */
