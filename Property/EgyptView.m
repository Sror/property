...
-(void)setEgyptViewAlignment
{
    if(((AppDelegate *)[UIApplication sharedApplication].delegate).menuOpen == 1)
    {
        ...
        [line1 setFrame:CGRectMake(470, 39, 2, 680)];
        [line2 setFrame:CGRectMake(600, 39, 2, 680)];
        [line3 setFrame:CGRectMake(730, 39, 2, 680)];
        ...
        [line1 setFrame:CGRectMake(518, 39, 2, 680)];
        [line2 setFrame:CGRectMake(648, 39, 2, 680)];
        [line3 setFrame:CGRectMake(778, 39, 2, 680)];
...
- (void)viewDidLoad
{
    ...
    //load all
    [propertyManager LoadPropertyList:0 :0 :0 :categryId];
