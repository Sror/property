...
@synthesize propertyName,scrollContainer,nextOutlet,previousOutlet,imageScroll,pageControl,dataContentScroll;
...
-(void)setDetailsViewAlignment
{
    ...
    {
        [self.scrollContainer setFrame:CGRectMake(1024, 0, 1024, 684)];
        [UIView  beginAnimations: @"Showinfo"context: nil];
        [UIView setAnimationCurve: UIViewAnimationCurveEaseInOut];
        [UIView setAnimationDuration:0.5];
        [self.scrollContainer setFrame:CGRectMake(48, 0, 1024, 684)];
    ...
    else
    {
        ...
        [UIView setAnimationCurve: UIViewAnimationCurveEaseInOut];
        [UIView setAnimationDuration:0.5];
        [self.scrollContainer setFrame:CGRectMake(0, 0, 1024, 684)];
        [UIView commitAnimations];
    }
...
- (void)viewDidLoad
{
    ...
    propertyName.text = @"Elegant Compound In Shekh Zaid";
...
- (IBAction)propertyFacts:(id)sender {
    ...
    deliveryDateTxt.text = @"Readt to move in";
...
- (IBAction)description:(id)sender {
    ...
    description.text = @"description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description description ";
...
- (IBAction)related:(id)sender {
    ...
    for(ImageItem *imageItem in [magazine MagazineImageList])
    {
        ...
        Txt.text = @"Classy Compund in Down Town";
